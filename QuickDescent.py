...
class qiuck:
    def work(self):
        ...
        trigger = True
        while(trigger):
            Xes[0].append(Xes[0][iteration-1]-alfa*(2*(math.sin(Xes[0][iteration-1])+2*Xes[1][iteration-1]-2)*(math.cos(Xes[0][iteration-1]))+2*(math.cos(Xes[0][iteration-1])+Xes[1][iteration-1]-1.5)*(-math.sin(Xes[0][iteration-1]))))
            Xes[1].append(Xes[1][iteration-1]-alfa*(2*(math.sin(Xes[0][iteration-1])+2*Xes[1][iteration-1]-2)*2+2*(math.cos(Xes[0][iteration-1])+Xes[1][iteration-1]-1.5)))
